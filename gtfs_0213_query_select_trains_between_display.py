...
Usage:
    python gtfs_0213_query_select_trains_between_display.py databasename
...
Diskussion:    
Für einen Haltepunkt: Alle Fahrten (trips) zwischen 00:30 und 01:30 Uhr,
...
Diskussion:
Auch hier findet man Zeiten nach 23:59:59 Uhr. Das sind Fahrten, die
...
min_time_string = '00:30:00'
max_time_string = '01:30:00'
min_time2_string = '24:30:00'  # min_time_string + 24h
max_time2_string = '25:30:00'  # max_time_string + 24h
...
sql = f"""
    SELECT r.route_short_name, s.stop_name, t.trip_id, x.last_stop_name,
