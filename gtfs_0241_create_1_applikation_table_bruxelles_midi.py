...
Creates table: xtra_departures_bruxelles_midi (Part 1)

Usage:
    python gtfs_0241_create_1_applikation_table_bruxelles_midi.py databasename

Tested with feed "The NMBS/SNCB Belgian railway company"

Version: 2021-06-30 ... Version 001   
...
sql = "DROP TABLE IF EXISTS xtra_departures_bruxelles_midi"
mycursor.execute(sql)

# Create new "extra" table: All departures from Leipzig Hbf.
sql = f'''
    CREATE TABLE xtra_departures_bruxelles_midi AS (
...
start_time = time()
sql = f"""
    UPDATE xtra_departures_bruxelles_midi
