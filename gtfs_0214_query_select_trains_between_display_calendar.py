...
Usage:
    python gtfs_0214_query_select_trains_between_display_calendar.py databasename

Tested with feed "Schienenfernverkehr" from gtfs.de.

Version: 2021-06-19 ... Version 003   
...
Die Tabellen calendar und calendar_dates werden in diesem Beispiel verwendet.
