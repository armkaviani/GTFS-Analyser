...
Creates table: xtra_departures_berlin_hbf

Usage:
    python gtfs_0221_create_1_applikation_table_berlin_hbf.py databasename

Tested with feed "Schienenfernverkehr" from gtfs.de.

Version: 2021-06-29 ... Version 003   
    
Diskussion:    
Für einen Haltepunkt: Alle Fahrten (trips) Diskussion:
Auch hier findet man Zeiten nach 24:00 Uhr. Das sind Fahrten, die
am Tag zuvor begonnen haben. Dafür wird "clock time" berechnet.
...
sql = "DROP TABLE IF EXISTS xtra_departures_berlin_hbf"
mycursor.execute(sql)

# Create new "extra" table: All departures from Berlin Hbf.
sql = f'''
    CREATE TABLE xtra_departures_berlin_hbf AS (
